return {
  ...
  -- use local version so I can more easily modify this
  dir = "~/ChatGPT.nvim",
  ...
  opts = function(_, opts)
    ...
    -- readme differs, but these are the actual keys used
    opts.predefined_chat_gpt_prompts = "file:///" .. vim.fn.expand "~" .. "/.config/nvim/lua/plugins/prompts.txt"
